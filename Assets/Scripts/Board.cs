...
public enum TileKind { normal, stone, box, vase}

//Define the type of tile in the level layout
[System.Serializable]
...
public class Board : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Is level valid? If not reset ###BUGFIX >= replaced with >
    ...
    {
        yield return new WaitForSeconds(0.1f); // Wait for vertical
    ...
    //Move the cubes down, if there is an obstacle below stop
    ...
    //Check if there is an obstacle above the current cell
    ...
    public void DamageAdjacentVases(int x, int y)
    {
